 ...
 */
export type AnySQLParameter = classes.SQLParameter<string, t.Mixed>;
 ...
 * @param validation The native `io-ts` validation object, used to validate values passed as this parameter.
 * @returns A new instance of {@link classes.SQLParameter} to be used within SQL string template literal.
 */
export const param = <TName extends string, TValidation extends t.Mixed>(
  name: TName,
